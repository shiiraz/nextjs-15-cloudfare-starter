...
var oe = /* @__PURE__ */ __name((e, t, r, s) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let n of ae(t))
      !ie.call(e, n) && n !== r && j(e, n, { get: () => t[n], enumerable: !(s = re(t, n)) || s.enumerable });
  return e;
}, "oe");
var V = /* @__PURE__ */ __name((e, t, r) => (r = e != null ? se(ne(e)) : {}, oe(t || !e || !e.__esModule ? j(r, "default", { value: e, enumerable: true }) : r, e)), "V");
var g;
var u = M(() => {
  g = { collectedLocales: [] };
});
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.7560831618421928.mjs.map
